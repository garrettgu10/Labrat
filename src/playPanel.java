...
public class playPanel extends JPanel{
	...
	public void paint(Graphics g){
		...
		drawArrow(g,displayedAngle,displayedDrag);
	}
	
	void drawArrow(Graphics g, double angle, double drag) { 
		//edited from: http://stackoverflow.com/questions/4112701/drawing-a-line-with-arrow-in-java
        Graphics2D g2 = (Graphics2D) g.create();
        
        int len = (int) (drag*u*3);
        ...
        g2.fillPolygon(new int[] {len/2, len/2-ARROW_SIZE, len/2-ARROW_SIZE, len/2},
